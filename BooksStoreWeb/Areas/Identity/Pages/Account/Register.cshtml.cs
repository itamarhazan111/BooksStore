...
namespace BooksStoreWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            var listComp = await _unitOfWork.Company.GetAllAsync();
            ...
            Input = new()
            {
                ...
                CompanyList = listComp.Select(x => new SelectListItem
                {
                    Text = x.Name,
                    Value = x.Id.ToString()
                })
